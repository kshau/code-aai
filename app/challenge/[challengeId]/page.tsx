...
export default function ChallengePage() {
	...
	const [codeSubmissionResult, setCodeSubmissionResult] = useState<ChallengeSubmissionResult | null>(null);
	...
	const attemptChallengeSolve = async () => {
		try {
			...
			console.error(
				"Error while attempting to solve the challenge:",
				error
			);
			setErrorMessage(
						...
						{isSolvedAlready ? (
							<div className="flex flex-col h-full justify-center items-center pb-32">
								...
								<span className="text-center mt-4">
									You already solved this challenge. Good
									work!
								</span>
							</div>
						) : errorMessage ? (
							...
							codeSubmissionResult.failedTestCase !== null ? (
								<>
									<CardDescription className="mb-4">
										...
										/{codeSubmissionResult.totalCases} test
										cases to fail! Details are below for one
										of them.
									</CardDescription>
								...
								<div className="flex flex-col h-full justify-center items-center pb-32">
									...
									<span className="text-center mt-4">
										Your code passed all test cases! Great
										job, +
							...
							<CardDescription>
								Test your code against the test cases by
								pressing run. This is a{" "}
