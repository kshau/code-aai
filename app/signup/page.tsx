      ...
      <CardContent>
        <form onSubmit={handleSignupFormSubmit} className="flex flex-col gap-y-4 pt-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={userSignupRequestData?.gradeLevel?.toString()} onValueChange={(value) => {editUserSignupRequestDataField("gradeLevel", value)}}>
          ...
          <div className="space-y-2 mb-4">
            ...
            <RadioGroup value={userSignupRequestData?.codingExperience} onValueChange={value => {editUserSignupRequestDataField("codingExperience", value)}} className="flex flex-col space-y-1">
